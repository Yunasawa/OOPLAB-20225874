...
public class StoreScreen extends JFrame
{
	...
	public static void initSetup() 
	{
	        ...
	        DigitalVideoDisc dvd2 = new DigitalVideoDisc(1, "Star War", "Science Fiction", "George Lucas", 87, 24.95f);
	        DigitalVideoDisc dvd3 = new DigitalVideoDisc(2, "Aladin", "Animation", null, 0, 18.99f);
	        store.addMedia(dvd1);
	        store.addMedia(dvd2);
	        store.addMedia(dvd3);


	        Book book = new Book(3, "The Valley of Fear", "Detective", 20.00f);
	        Book book1 = new Book(4, "A Living Remedy: A Memoir", "Biography", 202.00f);
	        Book book2 = new Book(5, "On the Origin of Time: Stephen Hawking's Final Theory", "Science", 120.00f);
	        store.addMedia(book);
	        store.addMedia(book1);
	        store.addMedia(book2);


	        CompactDisc cd1 = new CompactDisc(6, "Adele - 30", "Music","Adele", 1500.98f);
